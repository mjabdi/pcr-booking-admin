...
export default class TimeService{
     ...
     static getFirstAvailableDate =  () =>
    {
        ...
        return API.get('/api/paediatrician/time/getfirstavaiabledate');
    }
    ...
    {        
       ...
       return API.get('/api/paediatrician/time/getfullybookeddays');
    }
    ...
    static getTimeSlots = (date) =>
    {
        ...
        return API.get(`/api/paediatrician/time/gettimeslots?date=${date_utc}`);
    }
