        ...
        <Paper className={classes.paper}>
          ...
          <React.Fragment>
            ...
            <Typography variant="h6" gutterBottom>
              ...
              <p>
                {" "}
                We have emailed your new booking information, and will look
                forward to meet you at the clinic.
              </p>
              <p>
                {" "}
                If you still have more changes to do click the button below:{" "}
              </p>
            </Typography>
            <br />
