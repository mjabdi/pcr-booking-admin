...
import TimeService from './../../services/DentistTimeService';
                              ...
                              {timeSlots.map((timeSlot) => (
                                <GridListTile key={timeSlot.time} cols={1}>
                                  <div 
                                      ...
                                      className={(timeSlot.available || state.userBooking.bookingTime === timeSlot.time) ? (((state.bookingTime || state.userBooking.bookingTime) === timeSlot.time)? classes.boxSelected : classes.box ): classes.boxDisable}>
                                      {timeSlot.time}
                                  </div>
                                </GridListTile>
                              ))}
