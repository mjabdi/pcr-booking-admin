...
import doctorImage from "./../../images/Clear-skin-clinic.png";
...
import DermaBookService from "../../services/DermaBookService";
...
export default function WelcomeUser() {
  ...
  const submitForm = () => {
    ...
    if (ValidateFormData(formData)) {
      setSubmitting(true);
      DermaBookService.submitFormData(state.userBooking._id, formData)
        .then((res) => {
          setSubmitting(false);
