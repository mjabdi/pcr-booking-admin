...
import ScreeningBookService from './../../services/ScreeningBookService';
...
export default function NavigatorUser(props) {
    ...
    useEffect(() => {
        document.title = "Health Screening Registration Form"
     }, []);
...
if (props.pathId && props.pathId.length === 24)
        {
            ScreeningBookService.getBookingById(props.pathId).then( res => {
