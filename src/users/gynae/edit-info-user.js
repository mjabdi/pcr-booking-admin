...
const [firstname, setFirstname] = React.useState(state.userBooking.fullname ?? '');
    ...
    <React.Fragment>
      ...
      <main className={classes.layout}>
          ...
          <Grid container spacing={3} alignItems="baseline" style={{paddingTop:"20px", paddingBottom:"20px"}}>
                        ...
                        <Grid item xs={12} md={6}>
                            <TextField 
                                    ...
                                    required id="firstName" label="Full Name" 
        ...
        {/* <Divider/> */}
            ...
            <Grid container spacing={3} alignItems="baseline" style={{paddingTop:"0px", paddingBottom:"20px"}}>
                ...
                <Grid item xs={12} md={12}>
                            <FormControl className={classes.formControl} fullWidth required>
                                ...
                                >
                                  {
                                    Packages.map( item => (
                                      <MenuItem value={item.packageName}>{item.packageName}</MenuItem>
                                    ))
                                  }
                                </Select>
                        </FormControl>
